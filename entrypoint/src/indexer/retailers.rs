...
use retailers::{
    ...
    html::{
        ...
        Latulippe, LeverArms, MagDump, Marstar, PDEnterprises, RangeviewSports, Rdsc, ReliableGun,
        SJHardware, SoleyOutdoors, Tenda, TheAmmoSource, TheGunDealer, Tillsonburg, TrueNorthArms,
