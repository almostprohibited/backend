...
use retailers::{
    ...
    html::{
        ...
        DoubleTapSports, EllwoodEpps, FirearmsOutletCanada, FrontierFirearms, Fwgc, G4CGunStore,
        Gobles, GoldNLoan, GreatNorthGun, InterSurplus, InternationalShootingSupplies,
